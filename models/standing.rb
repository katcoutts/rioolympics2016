...
class Standing
  ...
  def order_by_points()
    ...
    @nations.each do |nation|
      nation_points << ({name: nation.name, gold_medals: nation.nation_gold_medals_count, silver_medals: nation.nation_silver_medals_count, bronze_medals: nation.nation_bronze_medals_count, points: nation.nation_points, id: nation.id, flag: nation.flag})
    end
